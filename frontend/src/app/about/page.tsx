...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 font-sans text-slate-200 overflow-x-hidden selection:bg-brand/20">
      {/* Background Glows */}
      ...
      <main className="relative pt-40 pb-24 px-6 md:px-12 space-y-32">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="p-12 md:p-16 glass-panel space-y-8 relative overflow-hidden group bg-slate-900/40 border-white/5">
        ...
        {/* Value Grid */}
        <div className="max-w-7xl mx-auto space-y-20 py-20 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-12 rounded-[2.5rem] border border-white/5 bg-slate-900/60 hover:border-brand/30 hover:bg-slate-900 transition-all space-y-6 group">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-gradient-to-br from-brand via-brand/90 to-brand-light p-16 md:p-24 rounded-[4rem] text-center space-y-10 relative overflow-hidden shadow-3xl shadow-brand/30">
            ...
            <div className="flex justify-center flex-col sm:flex-row gap-6 pt-4">
              <Link 
                href="/dashboard"
                className="bg-white text-brand px-12 py-6 rounded-[2.5rem] font-black text-3xl hover:scale-105 transition-all shadow-3xl flex items-center gap-4 active:scale-95 transition-all"
              >
