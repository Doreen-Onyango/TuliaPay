  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {data.map((m, i) => (
          <div key={i} className="glass-panel p-10 group hover:border-brand/40 transition-all shadow-lg hover:shadow-brand/5 border-white/5 bg-slate-900/40 rounded-[2.5rem]">
